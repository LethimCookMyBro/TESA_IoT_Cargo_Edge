...
export const HookScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: "#0b0f19", overflow: "hidden" }}>
      {/* Background capture image with subtle zoom */}
      <div
        style={{
          position: "absolute",
          inset: 0,
      ...
      >
        ...
        >
          ...
          >
            จากการขนส่งที่มองไม่เห็นความเสี่ยง
            <br />
            <span
              style={{
        ...
        >
          ระบบวิเคราะห์แรงสั่นสะเทือน ปรับความเร็ว เลือกเส้นทาง
