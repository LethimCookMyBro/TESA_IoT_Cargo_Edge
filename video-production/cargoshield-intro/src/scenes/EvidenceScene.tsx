    ...
    <AbsoluteFill style={{ backgroundColor: "#0b0f19", color: "#ffffff" }}>
      ...
      >
        ...
        <div style={{ textAlign: "center" }}>
          ...
          >
            หลักฐานผลการทดสอบและตัวชี้วัดโมเดล
          </h2>
          <p style={{ margin: "6px 0 0", fontSize: 22, color: "#94a3b8" }}>
            ข้อมูลจริงอ่านจาก reports/metrics.json และรายงานทดสอบ E2E ล่าสุด
          </p>
        </div>

        {/* 3 Main Metric Category Cards */}
        <div
          style={{
            display: "grid",
        ...
        >
          {/* Card 1: System Integration & Automated Tests */}
          <div
            style={{
              opacity: card1,
          ...
          {/* Card 3: Model Metrics & Provenance */}
          <div
            style={{
              opacity: card3,
              backgroundColor: "rgba(15, 23, 42, 0.9)",
        ...
        >
          ...
          <span style={{ color: "#ffffff", fontSize: 22, fontWeight: 500 }}>
            ตัวเลขการประมวลผลทั้งหมดเป็นผลลัพธ์จาก local simulator บน workstation ไม่ใช่ประสิทธิภาพการ inference บนบอร์ดฮาร์ดแวร์จริง
          </span>
        </div>
      </div>
    </AbsoluteFill>
